         ...
         <div class="page-title">
          <div>
            ...
            <ul class="breadcrumb side">
             ...
             <a class="btn btn-primary btn-xs " href="<?=base_url()?>admin/mesajlar/ekle"><i class="fa fa-plus" aria-hidden="true"></i> Üye Ekle</a>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <tr>
					  ...
					  <td><a href ="<?=base_url()?>admin/mesajlar/adminnotusil/<?=$rs->Id?>" class="btn btn-info" onclick="return confirm('silmek istediginizden emin misiniz')" ><i class="fa fa-trash-o" aria-hidden="true"></i></td>

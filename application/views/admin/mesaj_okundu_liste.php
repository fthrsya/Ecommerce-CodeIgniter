                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <tr>
					  ...
					  <td><a href ="<?=base_url()?>admin/mesajlar/okundusil/<?=$rs->Id?>" class="btn btn-info" onclick="return confirm('silmek istediginizden emin misiniz')" ><i class="fa fa-trash-o" aria-hidden="true"></i></td>
